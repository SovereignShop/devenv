...
- [X] Smooth edges
** TODO Static Mixer
*** TODO Static mixer attachment mechanism
** TODO Update check valve to use circular spring housing
** DONE Isocyanate SBR rubber exposure test.
** TODO Weighted attachments
Need to design attachments that hold the weights
to keep the models submerged while curing.
