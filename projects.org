...
#+CAPTION: Clock summary at [2021-04-11 Sun 23:01]
| Headline                                 |    Time |      |      |
|------------------------------------------+---------+------+------|
| *Total time*                             | *20:36* |      |      |
|------------------------------------------+---------+------+------|
...
| [[file:/home/john/Workspace/projects.org::*\[\[elisp:(org-projectile-open-project "recurs")\]\[recurs\]\]][recurs]]                                   |    1:12 |      |      |
...
* [[elisp:(org-projectile-open-project "off-grid")][off-grid]] [0/1]
:PROPERTIES:
:CATEGORY: off-grid
:END:
** TODO Try sketchup of dome model on Windows
* [[elisp:(org-projectile-open-project "recurs")][recurs]] [0/3]
:PROPERTIES:
:CATEGORY: recurs
:END:
** TODO Migrate editor in skyhook to recurs
...
:END:
** TODO replace editor in skyhook to use toko
:LOGBOOK:
CLOCK: [2021-04-13 Tue 17:19]
:END:
